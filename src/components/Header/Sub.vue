<template>
  <div class="bg-white middle p-5">
    <div class="w-full max-w-1200 gap-5 grid grid-cols-1-2max">
      <div class="flex">
        <button 
          class="uppercase text-xs font-medium text-primary/60 tracking-widest border-2 w-48 h-10 rounded-l-md border-r-0"
        >
          Dashboard
        </button>
        <button 
          class="uppercase text-xs font-medium text-primary/60 tracking-widest border-2 w-48 h-10 border-x-0 bg-primary !text-white border-primary"
        >
          Homiylar
        </button>
        <button 
          class="uppercase text-xs font-medium text-primary/60 tracking-widest border-2 w-48 h-10 rounded-r-md border-l-0"
        >
          Talabalar
        </button>
      </div>

      <div class="h-10 bg-dark-gray px-3 w-[284px] rounded-md flex gap-3">
        <div class="middle">
          <i class="far fa-search text-silver" aria-hidden="true"></i>
        </div>
        <input type="search" class="block w-full h-full bg-transparent text-black" placeholder="Izlash" />
      </div>
